  ...
  triggers: [
    {
      ...
      trigger:
        "Event tracking, analytics implementation, funnel analysis, cohort analysis, A/B testing, experiment design, metric definition, tracking plan, PostHog, Mixpanel, Amplitude, GA4, BigQuery",
    },
  ],
  useWhen: [
