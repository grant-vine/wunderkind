...
program
  ...
  .description(
    [
      ...
      "V4 safe user-prompt optimization is enabled-context only, latest-user-message-only, and fails closed with whole-message passthrough for immutable or low-confidence content.",
...
program
  ...
  .addHelpText(
    ...
    [
      ...
      "  - V4 user-prompt optimization, when enabled, is latest-user-message-only and outside token-audit",
      "  - V4 passthrough reasons are runtime-report-only, not summary metadata guidance",
...
program
  ...
  .addHelpText(
    ...
    [
      ...
      "  - V4 safe user-prompt optimization is enabled-context only, latest-user-message-only, and fail-closed with whole-message passthrough",
      "  - V4 immutable exclusions include code, commands, paths, URLs, explicit requirements, compliance/legal/security wording, and quoted user text",
      "  - V4 passthrough reason visibility is runtime-report-only, not summary metadata guidance",
