...
- **Upstream alignment targets are frozen for this wave** — `oh-my-openagent` `4.19.1`, OpenCode host `1.18.4`, and `@opencode-ai/plugin` / `@opencode-ai/sdk` `1.18.4`. Goal replaces active terminology where Ralph Loop wording is historical only, while Ultrawork remains active.
