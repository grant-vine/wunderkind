...
**Package:** `@grant-vine/wunderkind` v0.27.9
...
- **Published baseline vs compatibility-wave contract** — the current beta-channel baseline is package `0.27.9` on OpenCode `1.18.31` / OMO `5.0.0-beta.62`. OMO v5 beta is in scope, `supportability-review` is part of the shipped promoted surface, and high-capability routing uses `openai/gpt-6-astra`.
