...
Wunderkind `0.27.6` moves the LazyCodex/OMO support contract onto the v5 beta stream for current ChatGPT model support, including GPT-6 Astra, and switches npm release publishing to trusted publishing.
